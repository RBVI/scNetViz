...
public class GXALoadExperimentTaskFactory extends AbstractTaskFactory {
	final ScNVManager scManager;
	final GXASource gxaSource;

	public GXALoadExperimentTaskFactory(final ScNVManager scManager, final GXASource gxaSource) {
		super();
	...
	public TaskIterator createTaskIterator() {
		...
		ti.append(new GXALoadExperimentTask(scManager, gxaSource));
		return ti;
	}
